...
Wararit Panichkitkosolkul [@Panichkitkosolkul2013] introduced the following CI for 
...
$$
\biggl(\frac{cv\sqrt{n}}{\sqrt{b}}
\le CV \le
\frac{cv\sqrt{n}}{\sqrt{a}}
\biggr)
$$
Then, shortest-length 95\% CI for $x$ is:    
```{r eval = TRUE, warning=FALSE, message=FALSE}
cv(
    x, 
    na.rm = TRUE, 
